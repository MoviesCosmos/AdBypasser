...
st.set_page_config(page_title="URL Bypasser", page_icon='🧊',
                   layout="centered", initial_sidebar_state="auto",    menu_items={
                       'Get Help': 'https://telegram.me/PreetamKB',
                       'Report a bug': "https://telegram.me/PreetamKB",
                       'About': "This is URL Bypasser for many shortlink ad based website. Made by [Preetam](https://telegram.me/PreetamKB)"
                   })
...
tab1, tab2 = st.tabs(["Bypass a link [Made with 💕 by PKB]", "Supported Websites", ])
...
with tab1:
    ...
    if st.button("Submit [Try your luck!🤞]"):
        if url:
            try:
